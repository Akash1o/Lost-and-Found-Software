...
const Found = () => {
  ...
  return (
    <div className=' bg-gradient-to-br from-pink-100 to-yellow-100'>
          ...
          <div>
            {foundDataList && foundDataList.length > 0? <ul className="grid   gap-2 grid-cols-1 four:grid-cols-2 nine:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 w-[90%] mx-auto  ">
